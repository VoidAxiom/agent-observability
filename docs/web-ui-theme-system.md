# Web UI Theme + Palette System — 21-combo Portable Brief

Source-of-truth for the web app's theming architecture. The cyberpunk
discipline from [`web-ui-cyberpunk-discipline.md`](./web-ui-cyberpunk-discipline.md)
is one specific style+palette combination in this system (`neon` + `neon-tokyo`,
the default).
