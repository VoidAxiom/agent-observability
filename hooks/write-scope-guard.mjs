...
//   sdk/** collector/** clickhouse/** bin/** app/** config/**  — comma- or space-separated dir-prefix globs the
...
//   agent-observability      — used only in the worktree-root inference comment
//
...
//                            scripts/** · **/*.test.* · sdk/** collector/** clickhouse/** bin/** app/** config/**
...
function resolveWriteRoot(j, isSub, isImplAgent, agentType, rawFp) {
  ...
  // scripts/worktree-new.sh sit at <repo-parent>/.agent-observability-worktrees/<name>/
